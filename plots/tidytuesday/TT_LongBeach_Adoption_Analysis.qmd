...
image: images/TT9_LongBeach_Adoption_Plot.png
description: "TidyTuesday submission 2025 week 9"
---

![](images/TT9_LongBeach_Adoption_Plot.png){.lightbox width="50%"}

## About

Long Beach Adoption.  Plot shows adoptions per month from 2017-2024, adoptions by animal type and how long animals are at the shelter prior to adoption.
...
my_theme <- function() {
  theme_minimal(base_size = 16) +
    theme(
      ...
      panel.background = element_rect(fill = "white", color = NA),  # Transparent background
      plot.background = element_rect(fill = "white", color = NA)  # Transparent plot background
    )
}
...
ggsave("../results/TT9_LongBeach_Adoption_Plot.png", w = 8, h = 6, bg = "white")
```
